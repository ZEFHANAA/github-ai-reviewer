...
@section('content')
    <section class="mx-auto max-w-3xl px-6 py-20 sm:py-28 lg:px-8">
        <div class="rounded-2xl border border-white/10 bg-white/5 p-8 sm:p-10">
            <p class="text-sm font-semibold text-indigo-200">419</p>
            <h1 class="mt-3 text-3xl font-semibold tracking-tight text-white sm:text-4xl">Session expired</h1>
            <p class="mt-5 text-base leading-7 text-slate-300">Your session expired for security reasons. Please go back and try again.</p>
